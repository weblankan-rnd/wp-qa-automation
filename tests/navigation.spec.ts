...
test.describe('Navigation', () => {
  test('all primary nav links resolve without 4xx/5xx @smoke', async ({ page, request }) => {
    ...
    // supercorals.hostweblankan.in: primary nav is ul#primary inside #navbar_main_mobile
  ...
  test('active page is highlighted in navigation', async ({ page }) => {
    ...
    // supercorals.hostweblankan.in uses .current-menu-item on <li> and aria-current="page" on <a>
